...
const Question = ({
  ...
  const faqs = [
    ...
    {
      question: "지도가 일부 보이지 않아요.",
      answer: "빠르게 줌 인/아웃할 경우 지도가 렌더링되지 않는 문제가 발생할 수 있습니다. 일시적인 현상이므로 페이지를 새로고침(로고 클릭) 해보세요. 문제가 지속되면 문의하기를 통해 상세 내용을 알려주세요."
    },
    {
      question: "지도가 아예 보이지 않아요.",
      answer: "MAC OS 에서는 업데이트하지 않을 경우 위치를 가져오는 데 문제가 발생할 수 있습니다. 업데이트를 진행한 후 다시 시도해주세요."
    },
    {
      question: "서비스 운영 비용은 어떻게 충당하나요?",
      answer: "작고 소중한 월급으로 충당하고 있습니다. 후원 문의는 cjkimhello97@gmail.com 연락주세요. :)"
    }
  ]
